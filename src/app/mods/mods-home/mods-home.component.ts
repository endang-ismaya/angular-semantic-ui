...
export class ModsHomeComponent implements OnInit {
  ...
  items = [
    ...
    },
    {
      ...
      content:
        'There are many breeds of dogs. Each breed varies in size and temperament. Owners often select a breed of dog  they find to be compatible with their own lifestyle and desires from a companion.',
    },
    {
